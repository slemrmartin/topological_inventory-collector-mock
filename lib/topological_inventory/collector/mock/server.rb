require "topological_inventory/collector/mock/entity_type"
require "topological_inventory/collector/mock/event_generator"
    ...
    module Mock
      class Server
        ...
        def class_for(type)
          ...
          %W(TopologicalInventory::Collector::Mock::#{collector_type.to_s.classify}::#{type.to_s.classify}
         TopologicalInventory::Collector::Mock::#{type.to_s.classify}).each do |class_name|
