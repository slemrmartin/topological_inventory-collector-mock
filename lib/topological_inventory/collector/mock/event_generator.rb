require "topological_inventory/collector/mock/event"
  ...
  module Collector
    module Mock
      class EventGenerator
        ...
        # @param entity_type [TopologicalInventory::Collector::Mock::EntityType]
        # @param server [TopologicalInventory::Collector::Mock::Openshift::Server]
