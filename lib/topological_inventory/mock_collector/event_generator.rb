require "topological_inventory/mock_collector/event"
...
module TopologicalInventory
  module MockCollector
    class EventGenerator
      ...
      # @param entity_type [TopologicalInventory::MockCollector::EntityType]
      # @param server [TopologicalInventory::MockCollector::Openshift::Server]
