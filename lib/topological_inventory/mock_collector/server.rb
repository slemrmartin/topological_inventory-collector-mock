require "topological_inventory/mock_collector/entity_type"
require "topological_inventory/mock_collector/event_generator"
  ...
  module MockCollector
    class Server
      ...
      def class_for(type)
        ...
        %W(TopologicalInventory::MockCollector::#{collector_type.to_s.classify}::#{type.to_s.classify}
         TopologicalInventory::MockCollector::#{type.to_s.classify}).each do |class_name|
