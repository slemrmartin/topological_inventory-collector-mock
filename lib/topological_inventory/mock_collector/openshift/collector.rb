require "topological_inventory/mock_collector/collector"
require "topological_inventory/mock_collector/openshift/parser"
require "topological_inventory/mock_collector/openshift/server"

module TopologicalInventory
  module MockCollector
    module Openshift
      class Collector < ::TopologicalInventory::MockCollector::Collector
        def path_to_config
          File.expand_path("../../../../config/openshift", File.dirname(__FILE__))
        end

        def connection
          @connection ||= TopologicalInventory::MockCollector::Openshift::Server.new
        end
        ...
        def entity_types
          ...
          when :normal then
            TopologicalInventory::MockCollector::Openshift::Storage.entity_types
          when :reversed then
            TopologicalInventory::MockCollector::Openshift::Storage.entity_types.reverse
          else
        ...
        def parser_class
          TopologicalInventory::MockCollector::Openshift::Parser
        end
      end
    end
  end
