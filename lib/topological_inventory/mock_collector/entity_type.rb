...
module TopologicalInventory
  module MockCollector
    class EntityType
      ...
      # @param storage [TopologicalInventory::MockCollector::Storage]
      ...
      def entity_class
        ...
        class_name = "TopologicalInventory::MockCollector::#{collector_type.to_s.classify}::Entity::#{@name.to_s.classify}"
      ...
      # @param dest_entity_type [Symbol] one of TopologicalInventory::MockCollector::Storage.entity_types
